...
START_TEST(s21_sub_test_20) {
  ...
  ck_assert_uint_eq(res.bits[1], 0);
  ck_assert_uint_eq(res.bits[2], 0);
  ck_assert_uint_eq(res.bits[3], 2147680256);  // ответ -0.000
}
END_TEST
...
START_TEST(s21_sub_test_22) {
  ...
  ck_assert_uint_eq(res.bits[1], 0);
  ck_assert_uint_eq(res.bits[2], 0);
  ck_assert_uint_eq(res.bits[3], 2147483648);  // ответ -1
}
END_TEST
...
START_TEST(s21_sub_test_23) {
  ...
  ck_assert_uint_eq(res.bits[1], 0);
  ck_assert_uint_eq(res.bits[2], 0);
  ck_assert_uint_eq(res.bits[3], 0);  // 1
}
END_TEST
...
START_TEST(s21_sub_test_24) {
  ...
  ck_assert_uint_eq(res.bits[1], 0);
  ck_assert_uint_eq(res.bits[2], 0);
  ck_assert_uint_eq(res.bits[3], 0);  // 3
}
END_TEST
...
START_TEST(s21_sub_test_25) {
  ...
  ck_assert_uint_eq(res.bits[1], 0);
  ck_assert_uint_eq(res.bits[2], 0);
  ck_assert_uint_eq(res.bits[3], 2147483648);  // -3
}
END_TEST
...
START_TEST(s21_sub_test_29) {
  ...
  ck_assert_uint_eq(res.bits[1], 0);
  ck_assert_uint_eq(res.bits[2], 0);
  ck_assert_uint_eq(res.bits[3], 2147483648);  // -1
}
END_TEST

START_TEST(s21_sub_test_30) {
  s21_decimal d1 = {{4294967295, 4294967295, 4294967295, 0}, 0};  // max_decimal 79228162514264337593543950335
  s21_decimal d2 = {{1, 0, 0, 0}, 0};
  s21_decimal res = s21_sub(d1, d2);
  ck_assert_int_eq(res.value_type, 0);
  ck_assert_uint_eq(res.bits[0], 4294967294);
  ck_assert_uint_eq(res.bits[1], 4294967295);
  ck_assert_uint_eq(res.bits[2], 4294967295);  // ответ 79228162514264337593543950334
  ck_assert_uint_eq(res.bits[3], 0);
}
END_TEST
...
START_TEST(s21_sub_test_32) {
  s21_decimal d1 = {{4294967295, 4294967295, 4294967295, 2147483648}, 0};  // min_decimal -79228162514264337593543950335
  s21_decimal d2 = {{1, 0, 0, 0}, 0};  // 1
  s21_decimal res = s21_sub(d1, d2);
  ck_assert_int_eq(res.value_type, s21_NEGATIVE_INFINITY);
  ck_assert_uint_eq(res.bits[0], 0);
...
START_TEST(s21_sub_test_33) {
  ...
  ck_assert_uint_eq(res.bits[3], 2147483648);  // ответ -79228162514264337593543950334
}
END_TEST

START_TEST(s21_sub_test_34) {
  s21_decimal d1 = {{4294967294, 4294967295, 4294967295, 0}, 0};  // max_decimal-1 (79228162514264337593543950334)
...
START_TEST(s21_sub_test_36) {
  ...
  s21_decimal res = s21_sub(d1, d2);
  ck_assert_int_eq(res.value_type, 0);
  ck_assert_uint_eq(res.bits[0], 4294967293);
  ck_assert_uint_eq(res.bits[1], 4294967295);
  ck_assert_uint_eq(res.bits[2], 4294967295);  // ответ 79228162514264337593543950333
  ck_assert_uint_eq(res.bits[3], 0);
}
END_TEST
...
START_TEST(s21_sub_test_37) {
  ...
  ck_assert_uint_eq(res.bits[1], 4294967295);
  ck_assert_uint_eq(res.bits[2], 4294967295);  // ответ 79228162514264337593543950335 
  ck_assert_uint_eq(res.bits[3], 0);
}
END_TEST
